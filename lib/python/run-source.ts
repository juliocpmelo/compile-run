 ...
 */
export async function runPythonSourceCode(soureCode: string, options: Python_Options, callback: errorResultCallback): Promise<Result>
 ...
 * @param options Optional Options object
 */
export async function runPythonSourceCode(soureCode: string, options?: Python_Options): Promise<Result>
...
async function runPythonSourceCodeAndReturnPromise(soureCode: string, options?: Python_Options): Promise<Result> {
